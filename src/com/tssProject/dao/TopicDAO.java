...
public class TopicDAO extends HibernateDaoSupport {
	...
	public List findByTiltle(Object tiltle) {
		return findByProperty(TILTLE, tiltle);
	}

	public List findByTcontent(Object tcontent) {
